...
public class StoreWindow extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(StoreWindow.class.getName());

    /**
     * Creates new form StoreWindow
     * @param idUser
     */
    public StoreWindow(int idUser) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("My Games", jPanel2);
